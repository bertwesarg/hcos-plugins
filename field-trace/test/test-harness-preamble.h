...
#define BITMASK_READ(RECORD, FIELD, INDEX, MASK, LINENO)	\
  { #RECORD, #FIELD, INDEX, 0, 0, MASK, LINENO }

#define BITMASK_WRITE(RECORD, FIELD, INDEX, MASK, LINENO)	\
  { #RECORD, #FIELD, INDEX, 1, 0, MASK, LINENO }

#define INERT_READ(RECORD, FIELD, INDEX, LINENO)	\
  { #RECORD, #FIELD, INDEX, 0, 0, 0x0, LINENO }
